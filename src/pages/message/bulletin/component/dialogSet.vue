 ...
 * @LastEditors: Nice
 * @LastEditTime: 2020-03-03 15:07:06
 -->
<template>
  <div
          ...
          <div class="append-handle-btn-input row">
            <q-input
              ...
              :rules="[ 
                ...
                val => /^[a-zA-Z]([_a-zA-Z0-9]{3,20})$/.test(val) || '用户名只能由字母、数字和下划线组成，且必须以字母开头！',       
                val => !noKeysWord.includes(val) || '不得使用该关键词作为管理员用户名',
              ]"
        ...
        <div>
          ...
          <div class="append-handle-btn-input row">
            <q-input
              ...
              lazy-rules
              :rules="[
                val => val !== null && val !== '' || '生成密码不能为空！请点击生成密码！',
              ]"
              disable
            ></q-input>
          </div>
    ...
    handleSave() {
      ...
      if (this.$refs.username.hasError || this.$refs.password.hasError) {
        ...
        if (this.detailObj.merchantAdmin) {
          ...
          let params = {
            id: this.detailObj.id,
            adminName: this.detailObj.merchantAdmin? this.detailObj.merchantAdmin: this.formData.merchantAdmin,
