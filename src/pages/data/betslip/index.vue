<template>
  <div class="full-width full-height position-relative">
    ...
    <div class=" fs14 bg-panda-bg-6 shadow-3 line-height-30px" style="margin: 0 10px 10px 10px; overflow-x: hidden;">
      <div id="top2" class="pt10x" style="min-width: 1600px;">
        <div class="row pl10x pb10x">
          ...
          <div class="append-handle-btn-input height-30px line-height-30px">
            <a-button
              type="primary"
          ...
          <div class="top line-height-32px" @click="handle_expand">
            <my-icon v-if="is_expand" type="p-icon-bottom" class="fs20 ml10x cursor-pointer"></my-icon>
            <my-icon v-else type="p-icon-top"  class="fs20  ml10x cursor-pointer"></my-icon>
          </div>
          <q-space />
          <a-dropdown>
            ...
            <!-- <a-button class="mr20x" type="primary" :loading='exportLoading'>
              导出报表
              <span><a-icon type="export" />导出报表</span>
            </a-button> -->
      ...
      <a-table
        ...
        :scroll="{ x: 1600, y: !is_expand? scrollHeight + 52: scrollHeight }"
        :pagination="false"
      ...
      <!-- style="position: fixed; bottom: 13px; right:10px;height: 55px; width: calc(100vw - 220px); background: #fff;" -->
      <a-pagination
      ...
      <div class="fs16 position-absolute" style="bottom: 11px; left: 25px;" v-if="tabledata.length>0 && !this.totalLoading">
        ...
        <span class="pr10x">
          <span class="title-grey">平台盈利率: </span>
          <span class="fw_600" v-if="userStatistics.sumProfitAmount && userStatistics.betAmount" :class="userStatistics.sumProfitAmount>0?'text-green': 'text-red'">
            <span v-if="userStatistics.sumProfitAmount > 0">-</span>{{ to_percent(Math.abs(userStatistics.sumProfitAmount)/userStatistics.betAmount)}}
          </span>
        </span>
