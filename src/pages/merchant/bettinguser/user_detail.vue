          ...
          <div class="fs16 line-height-16px pl20x pt20x text-panda-text-7 fw_600 row">
            <div>
              ...
              <a-tooltip trigger="hover">
                ...
                <a-icon type="question-circle" class="fs15 ml5x cursor-pointer" />
              </a-tooltip>
            </div>
          </div>
          <q-space/>
...
import userDashboard from 'src/pages/merchant/bettinguser/component/userDashboard.vue'
import userBet from 'src/pages/merchant/bettinguser/component/userBet.vue'
import userAccount from 'src/pages/merchant/bettinguser/component/userAccount.vue'
