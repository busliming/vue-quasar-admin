  ...
  <div class="full-height full-width bg-panda-bg-5  s99999 ">
    <div class="row p-fwnw">
      ...
      <div :style="main_component_style">
        <div class="p-fg1">
          <!-- 头部搜索条件区域 -->
          <div class="full-width pl20x pt20x fs12">
            <q-breadcrumbs separator=">" active-color="whiddte" class="text-panda-text-4">
              <q-breadcrumbs-el label="首页" />
              <q-breadcrumbs-el label="商户中心" />
              <q-breadcrumbs-el label="投注用户管理"  class="text-panda-text-7" />
            </q-breadcrumbs>
            <div class="shadow-1 " style="width: calc(100% - 20px)">
              <div
                class="row line-height-30px items-center text-panda-text-dark bg-panda-bg-6 pb20x q-pt-md"
              >
        ...
        <div class="panda-table-container">
          <q-table
            ...
            dense
            row-key="name"
            class="bg-panda-base-dark text-panda-text-light panda-table panda-sticky-header-table full-width line-height-38px"
          ...
          >
            ...
            <template v-slot:bottom>
              <panda-pagination
                class="pa p-b--md zi2 bg-panda-dark-dark"
                :total="total"
...
import tablerow from "src/pages/merchant/bettinguser/component/tablerow.vue";
...
import dialogMain from "src/pages/merchant/bettinguser/component/dialog_main.vue";
import log_login_mixin from "src/pages/merchant/bettinguser/mixin/index.js";
import mockdata from "src/pages/merchant/bettinguser/mock/index.js";
...
export default {
  ...
  methods: {
    ...
    compute_scrollarea_style() {
      let hs = this.window_size_info.height - 270;
