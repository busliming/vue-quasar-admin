  ...
  <div class="full-width full-height">
    <div class="pl20x mt20x">
      <q-breadcrumbs separator=">" active-color="whiddte">
        ...
        <q-breadcrumbs-el label="新建渠道商户" class="fw_600 text-panda-text-7 fs14" />
      </q-breadcrumbs>
    </div>
      ...
      <a-form id="components-form-edit" class="edit" :form="form" @submit="handleSubmit">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12">
            ...
            <div class="row" v-if="formData.directSale == 1 || formData.childConnectMode == 2">
              <div class="pl40x">
                <div class="text-panda-text-7 mb10x fw_600">
                  商户钱包类型
                  <span class="panda-text-red">*</span>
            ...
            <div class="row">
              ...
              <div class="col-4 ml30x">
                <div class="pl40x">
                  <div class="text-panda-text-7 mb10x fw_600">合作协议文件</div>
...
export default {
  ...
  methods: {
    ...
    handleDirectSaleChange(val){
      this.formData.directSale = val;
      if(this.formData.directSale === 2 && this.formData.childConnectMode === 1){
        this.formData.transferMode = 2;
      }
    },
    // 钱包类型
    ...
    handleChildConnectModeChange(e){
      this.formData.childConnectMode = e.target.value;
      if(this.formData.directSale == 2 && e.target.value == 1){
        this.formData.transferMode = 2;
      }
    },
    //生成随机6位数字
